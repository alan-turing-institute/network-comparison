...
double get_double_segment_constrained(double seg1Loc1, double seg1Loc2, double seg1Loc3, double seg1Val1, double seg1Val2, double seg2Loc1,  double seg2Loc2,  double seg2Loc3, double seg2Val1, double seg2Val2)
{
    double res=0;
  
    // compare the linear section with the linear section
    res += get_segment_constrained(seg1Loc1, seg1Loc2, seg2Loc1, seg2Loc2, seg1Val1, seg1Val2, seg2Val1, seg2Val2); 
    
    // compare the linear section with the flat section
    // This could be easily special cased (saving ~1 if statements ).
    res += get_segment_constrained(seg1Loc1, seg1Loc2, seg2Loc2, seg2Loc3, seg1Val1, seg1Val2, seg2Val2, seg2Val2); 

...
#' @export
net_emd <- function(dhists1, dhists2, method = "optimise", step_size = NULL, return_details = FALSE) {
...
min_emd_single_pair <- function(dhist1, dhist2, method = "optimise", step_size = NULL) {

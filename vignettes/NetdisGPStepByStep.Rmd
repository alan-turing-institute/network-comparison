...
tail(graphlet_counts_1)
tail(graphlet_counts_2)
```
...
## Calculate expected graphlet counts in each density bin by the Geometric-Poisson approximation ($E_w$)
```{r}
binned_gp_graphlet_counts_1 <- density_binned_counts_gp(graphlet_counts = graphlet_counts_1, 
                                                     density_interval_indexes =  binned_densities_1$interval_indexes, 
                                                     max_graphlet_size = max_graphlet_size)

binned_gp_graphlet_counts_2 <- density_binned_counts_gp(graphlet_counts = graphlet_counts_2, 
                                                     density_interval_indexes =  binned_densities_2$interval_indexes, 
                                                     max_graphlet_size = max_graphlet_size)
binned_gp_graphlet_counts_1
binned_gp_graphlet_counts_2
```
...
exp_gp_graphlet_counts_1 <- netdis_expected_counts(graphlet_counts = graphlet_counts_1,
                                                density_breaks = binned_densities_1$breaks, 
                                                density_binned_reference_counts =  binned_gp_graphlet_counts_1, 
                                                max_graphlet_size = max_graphlet_size,
                                                scale_fn=NULL)


exp_gp_graphlet_counts_2 <- netdis_expected_counts(graphlet_counts = graphlet_counts_2,
                                                density_breaks = binned_densities_2$breaks, 
                                                density_binned_reference_counts =  binned_gp_graphlet_counts_2, 
                                                max_graphlet_size = max_graphlet_size,
                                                scale_fn=NULL)
...
centred_graphlet_counts_1 <- netdis_subtract_exp_counts(graphlet_counts = graphlet_counts_1,
                                                        exp_graphlet_counts = exp_gp_graphlet_counts_1, 
                                                        max_graphlet_size = max_graphlet_size)

centred_graphlet_counts_2 <- netdis_subtract_exp_counts(graphlet_counts = graphlet_counts_2,
                                                        exp_graphlet_counts = exp_gp_graphlet_counts_2, 
                                                        max_graphlet_size = max_graphlet_size)

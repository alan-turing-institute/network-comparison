...
World trade networks consist of relatively dense networks, thus leading to longer computational times of the subgraph counts. Hence, it is advisable to pre-compute counts in case there is a need to call NetEmd multiple times, particularly when, for example, adding a new network to the data set. The following illustrates the extraction of subgraph counts for the small network sample.
...
* About 1995-1996: "*The WTO was created in January 1995, upon the completion of the Uruguay Round which established new rules for international trade in goods, services and intellectual property.*" WTO 1996 press releases (https://www.wto.org/english/news_e/pres96_e/anrep.htm).

...
expected_counts_gp <- function(graphlet_counts, bin_indexes, max_graphlet_size) {
...
binned_graphlet_counts_1 <- expected_counts_gp(graphlet_counts_1,
                                               binned_densities_1$interval_indexes,
                                               max_graphlet_size)

binned_graphlet_counts_2 <- expected_counts_gp(graphlet_counts_2,

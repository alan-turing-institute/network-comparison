...
netdis.plot(netdislist = netdisgp_mat_mybin,whatrow = 2, main = "Netdis-GP with reference graph - mybinning")
```
...
netdis.plot(netdislist = netdisgp_mat_others,whatrow = 2, main = "Netdis-GP: illustrative parameter changes")
```

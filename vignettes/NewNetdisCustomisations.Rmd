...
netdis_plot(netdislist = netdis_mat_zero, whatrow = 2, main = "Netdis Ew=0")

netdis_mat_5 <- netdis_many_to_many(
  graphs = glist,
  ref_graph = 5
)
netdis_plot(netdislist = netdis_mat_5, whatrow = 2, main = "Netdis Ew=5")
```
...
netdis_plot(netdisgp_mat, whatrow = 2, main = "Netdis-GP")
```

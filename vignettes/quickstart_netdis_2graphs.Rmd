...
## Bin reference ego networks by density and calculate mean graphlet counts in each bin
```{r}
...
exp_graphlet_counts_1 <- purrr::map(ego_1, netdis_expected_graphlet_counts,
                                    max_graphlet_size = max_graphlet_size,
                                    density_breaks = binned_densities$breaks,
                                    density_binned_reference_counts = density_binned_graphlet_counts)

exp_graphlet_counts_1 <- t(simplify2array(exp_graphlet_counts_1))

exp_graphlet_counts_2 <- purrr::map(ego_2, netdis_expected_graphlet_counts,
                                    max_graphlet_size = max_graphlet_size,
                                    density_breaks = binned_densities$breaks,
                                    density_binned_reference_counts = density_binned_graphlet_counts)

exp_graphlet_counts_2 <- t(simplify2array(exp_graphlet_counts_2))

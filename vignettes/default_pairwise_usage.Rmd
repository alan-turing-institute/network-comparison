...
goldstd_1 <- igraph::graph.lattice(c(round(sqrt(vcount(graph_1))),round(sqrt(vcount(graph_1))))) 

goldstd_2 <- igraph::graph.lattice(c(round(sqrt(vcount(graph_2))),round(sqrt(vcount(graph_2))))) 
